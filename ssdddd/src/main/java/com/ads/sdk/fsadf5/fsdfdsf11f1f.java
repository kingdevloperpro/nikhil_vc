...
public class fsdfdsf11f1f {
    Context activity;

    public fsdfdsf11f1f(Context context) {
    ...
    public void inflate_NB_FB(NativeBannerAd nativeBannerAd, ViewGroup cardView) {
        ...
        View view = null;
        view = inflater.inflate(R.layout.fdsgf, null);
    ...
    public void inflate_NATIV_FB(NativeAd nativeAd, ViewGroup card) {
        ...
        LayoutInflater inflater = LayoutInflater.from(activity);
        View adView = inflater.inflate(R.layout.f14df5df, null);

...
public class gf4fg4f4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_call_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (new fsdfdsf445(gf4fg4f4.this).getKeyInAppMode().equals("1")) {
                    if (new f4sdf48sd5f4().getVipType().equals("in_app_gold") || new f4sdf48sd5f4().getVipType().equals("in_app_silver") || new f4sdf48sd5f4().getVipType().equals("in_app_bronze")) {
                        ...
                        if (new f4sdf48sd5f4().isFreeIncomingActive()) {
                            new f4sdf48sd5f4().setFreeIncoming(false);
                            connectVideoCall();
                        } else {
                            startActivity(new Intent(gf4fg4f4.this, MainActivity.class));
                            finish();
                        }
                    }
                } else {
    ...
    private void connectVideoCall() {
        ...
        startActivity(new Intent(gf4fg4f4.this, g4fdg4f4g.class));
        finish();
    }
